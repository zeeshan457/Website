...
</div><button class="button buttonBlue"><a href="addproducts.php">ADD PRODUCT TO TABLE & DATABASE</a></button>
<br><br>
<table id="customers">
  <tr>
  <th>ID</th>
                     ...
                     <td>  <?php       
                         ...
                         <td>  <?php       
                            ...
                            echo $row['category'];
                             ?>  </td> 
                             <td>        
                            <img src="<?= $row['image']?>" width="80px" height="80px"/>
                               </td>  
                               <td>  
                          <button  class="buttonAction"><a href="editproducts.php?id=<?= $row['id'] ?>"> EDIT</a></button>
                               </td>

                               <td>       
                          <button  class="buttonAction"><a href="productspage.php?id=<?= $row['id'] ?>"> Delete</a></button>
                               </td>
                     </tr>
