...
<html lang="en">
<head>
<link href="CSS_files\admin_login_register.css" rel="stylesheet" type="text/css">
...
<div class="col-md-6 login-left">
  ...
  <form action="adminlogin.php" method="post">
    ...
    <div class="form-group">
      ...
      <a href="index.php">Are you a user? Click here</a>    
...
<div class="col-md-6 register-right">
  ...
  <form name="myForm" action="adminregister.php" onsubmit="return ValidateRegistration()" method="post">  
    <div classs="form-group">
      <label> Username </label>
      <input type="text" id = "username" name="user" class="form-control" required>
    </div>
